        ...
        <div class="col-md-9">
          <div class="box">
            <div class="box-header">
              <?php echo form_open_multipart('Pembangunan/Cek');?>
                <?php if(!empty($data)){?>     
                  <div class="col-md-5">
                <?php }else{?>
                  <div class="col-md-10">
          ...
          if (empty($detail)) {?>
              ...
              <div class="callout callout-warning" style="margin-bottom: 0!important;">
                <h4><i class="fa fa-warning"></i> Perhatian:</h4>
                  Daftar Prioritas Rencana Pembangunan <?=$nm_bidang?> Tahun <?=$thn_filter?> Belum Ada
              </div>
              <br>
          <?php }?>  
          <?php $nomor=1; foreach ($detail as $d) {?>
           <div class="row">       
          
          <div class="col-md-12">
            <div class="box box-solid">
              <div class="box-header with-border">
                <h3 class="box-title">Prioritas No <?=$nomor?>. <?=$d['nm_kegiatan']?> Lokasi RT <?=$d['rt']?> / RW <?=$d['rw']?></h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <div class="row">  
               ...
               <div class="col-md-6">
                ...
                <div class="box-footer clearfix">
                  ...
                  <ul class="pagination pagination-sm no-margin pull-right">
                    <li><a href="<?=base_url('index.php')?>/Pembangunan/Referensi/<?=$d['kd_rencana']?>">Lihat Referensi Aduan</a></li>
                  </ul>
                </div>
              </div>
              </div>
