        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="<?=base_url('index.php')?>/Aduan">Aduan Masyarakat</a></li>
               <?php if ($this->session->userdata('user_login')=="Masuk") {?>
              <li class="active"><a href="<?=base_url('index.php')?>/Aduan/Anda">Aduan Anda</a></li>
              <?php } ?>
            </ul>
            <div class="tab-content">
              ...
              <div class="user-block">
                ...
                <div class="img-push">
                  <a href="<?=base_url('index.php')?>/Aduan/Formulir"><input type="text" class="form-control" placeholder="Laporkan Aduan Anda Untuk Kemajuan Desa Jeruksari"></a>
                </div>
              </div>
              <?php }?>
            </div>
